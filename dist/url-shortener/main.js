...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        ...
        this.bgColor = '';
        this.colCount = 0;
        this.colorArr = ['oneBg', 'twoBg', 'threeBg', 'fourBg'];
        this.currColor = '';
    }
    //URL shortening function
    AppComponent.prototype.shorten = function () {
        var _this = this;
        var formattedUrl = this.formatUrl(this.urlData.long);
...
module.exports = __webpack_require__(/*! /Users/alexavita/Desktop/code/shrinkr/AWS/shrinkr/src/main.ts */"./src/main.ts");
